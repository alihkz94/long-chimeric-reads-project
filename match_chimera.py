'''
This script compares the chimeras generated by the script generate_chimeras.py with the chimeras 
detected by the script detect_chimeras.py. It calculates the proportion of generated chimeras that 
were successfully detected and reports the true positives, false positives, true negatives, 
and false negatives for the chimeras detected.
'''
